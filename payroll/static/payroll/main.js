...
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(empDasboardService, route) {
        this.route = route;
        this.columnDefs = [
    ...
    DashboardComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_employee_dashboard_service__WEBPACK_IMPORTED_MODULE_1__["EmployeeDashboardService"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"]])
    ], DashboardComponent);
...
var EmployeeDashboardService = /** @class */ (function () {
    function EmployeeDashboardService(httpc) {
        this.httpc = httpc;
        this.employeeDetails = [];
        this.url = 'payroll/employee/';
    }
    EmployeeDashboardService.prototype.getData = function (id) {
        var empid=id;
        var _this = this;
        var rowData=[];
        return _this.httpc.get(_this.url+empid).subscribe(function (data) {
                rowData.push(data);
    ...
    LoginComponent.prototype.onSubmit = function () {
        ...
        this.authenticationService.login(this.f.username.value, this.f.password.value)
            ...
            if (data['status'] === 'OK') {
                ...
                if (data['role'] === 'ADMIN') {
                _this.router.navigate(['uploadFile']);
                  // _this.router.navigate(['employeeDashboard', { id: empId }]);
                }
...
var FormUploadComponent = /** @class */ (function () {
    ...
    FormUploadComponent.prototype.upload = function () {
        ...
        for (var i = 0; i < this.selectedFiles.length; i++) {
            console.log("length is",this.selectedFiles.length);
